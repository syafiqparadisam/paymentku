...
const UserProfile = () => {
  ...
  // Buat state untuk user
  //   const [user, setUserState] = useState<User>(reduxUser);
  ...
  useEffect(() => {
    console.log("Wes tak ubah loh namae");
    cleanUp();
    setErr("");
    refetch();
        ...
        >
          ...
          <DialogContent>
            ...
            >
              ...
              <InputLabel
                htmlFor={label === "delete account" ? "password" : label}
              >
                {label === "delete account" ? "password" : label} :
              </InputLabel>
              {label != "Bio" ? (
                <TextField
