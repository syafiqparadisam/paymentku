      ...
      >
        ...
        >
          ...
          >
            ...
            {err?.data?.message && err?.status != 500 && (
              <Typography fontSize={"15px"} color={"red"} fontWeight={500}>
                {err.data.message}
              </Typography>
            )}
          </Box>
          <form onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
            ...
            >
              ...
              />
              {errors.user && (
                <Typography color="red">{errors.user.message}</Typography>
              )}
            </Box>
            <Box
              display={"flex"}
            ...
            >
              <Link
                ...
                to={"/signup"}
              >
                Didn't have an account ? Please signup
              </Link>
              <Link
                style={{ fontSize: "13px", textDecoration: "none" }}
                to={"/forgotPassword"}
