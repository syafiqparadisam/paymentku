...
type Server struct {
	svc  providertransaction.ProviderMethod
	port string
}
...
func NewServer(svc providertransaction.ProviderMethod, port string) *Server {
...
func (s *Server) Run() error {
	...
	defer fmt.Printf("Transaction Server is running on port %s\n", s.port)
