    ...
    <>
      ...
      >
        ...
        >
          ...
          {error && (
            <Typography textAlign={"center"} color={"red"} fontWeight={"bold"}>
              {error.data.message}
            </Typography>
          )}
          {isSuccess && (
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ width: "100%" }}>
            ...
            >
              ...
              <TextField
                ...
                {...register("confirmPassword", {
                  ...
                  validate: (value) =>
                    value === password ||
                    "Please match the value with password field",
                })}
                id="standard-basic"
              />
            ...
            >
              <Typography fontSize={"15px"}>
                If your token is invalid, you can get token by send email again
              </Typography>
              <Link
              ...
              <Link
                ...
                style={{ fontSize: "15px", textDecoration: "none" }}
              >
                Already update password? Please Login
              </Link>
            </Box>
            <Box
              display={"flex"}
