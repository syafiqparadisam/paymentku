...
func (s *Provider) NewHistoryTransfer(dto *dtotransaction.TransferRequest, decode *shared.UserJwtDecode) shared.APIResponse {
...
func createTransferInfo(dto dtotransaction.TransferRequest, userAndAccNum *mysqltransaction.UserAccNumAndEmail, balance *mysqltransaction.UserIdAndBalance) *mongotransaction.TransferInfo {

	return &mongotransaction.TransferInfo{
